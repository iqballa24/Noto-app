...
const MoreOptions = ({ onDelete, onArchive }) => {
  ...
  return (
    <div className="relative text-light-gray cursor-pointer group">
      ...
      <div className="hidden group-hover:flex flex-row absolute -top-3 right-6 md:-right-3 rounded-md px-4 py-3 shadow-lg space-x-3 bg-white dark:bg-dark-secondary">
        <HiTrash
          size={18}
